    ...
    <div>
      ...
      <div className="beachhack">
        ...
        <div className="beachhack-paragraphs">
          <p style={{textAlign: "justify"}}>Beach Hack is the flagship event hosted by  Community Of Developers(CODe), association of computer science  of Christ College Of Engineering, Irinjalakuda. The 5th edition of beach hack titled BEACH HACK 5 was held on 29th and 30th of December 2022. Beach hack is a 24 hour  beach hackathon, providing a platform for students to solve various problems faced by our society simultaneously improving their critical and creative thinking. Various students from all over India participated for the event.There were around 1000+ registrations,among these individual registration 13 teams were selected for the final level.</p>
