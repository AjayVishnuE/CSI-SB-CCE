    ...
    <div class="events-container">
        ...
        <div class="events">
            <div class="events-div">
                ...
                <h1 style={{fontSize: 20, fontWeight: 600, margin: 0, width:300}}>_bootUp </h1>
                <p style={{ textAlign: "justify", height: "fit-content", overflow: "hidden", fontSize:"medium", width: 300}}> An offline overnight bootcamp on web development.</p>
            ...
            <div class="events-div">
                ...
                <p style={{ textAlign: "justify", height: "fit-content", overflow: "hidden", fontSize:"medium", width: 300}}>One day offline workshop on web development.</p>
            ...
            <div class="events-div">
                ...
                <p style={{ textAlign: "justify", height: "fit-content", overflow: "hidden", fontSize:"medium", width: 300}}>One day game development workshop in Unity.</p>
            ...
            <div class="events-div">
                ...
                <p style={{ textAlign: "justify", height: "fit-content", overflow: "hidden", fontSize:"medium", width: 300}}>One day workshop on Hands on training in Django Frame...</p>
                <a style={{textAlign: "left", textDecoration: "none", color: "#183883", fontWeight: 500, width:300}} href="./event1.html">Read More</a>
            </div>
            <div class="events-div">
                <img src={Event5} alt="event-img"/>
                <h1 style={{fontSize: 20, fontWeight: 600, margin: 0}}>Laravel Workshop</h1>
                <p style={{ textAlign: "justify", height: "fit-content", overflow: "hidden", fontSize:"medium", width: 300}}>One day workshop on Larvel Web application framework </p>
                <a style={{textAlign: "left", textDecoration: "none", color: "#183883", fontWeight: 500, width:300}} href="./event2.html">Read More</a>
            </div>
            <div class="events-div">
                <img src={Event6} alt="event-img"/>
                <h1 style={{fontSize: 20, fontWeight: 600, margin: 0}}>Ideathon</h1>
                <p style={{ textAlign: "justify", height: "fit-content", overflow: "hidden", fontSize:"medium", width: 300}}>An idea pitching competition which was conducted in both ...</p>
                <a style={{textAlign: "left", textDecoration: "none", color: "#183883", fontWeight: 500, width:300}} href="./event3.html">Read More</a>
            </div>
            <div class="events-div">
                <img src={Event7} alt="event-img"/>
                <h1 style={{fontSize: 20, fontWeight: 600, margin: 0}}>IoT Workshop</h1>
                <p style={{ textAlign: "justify", height: "fit-content", overflow: "hidden", fontSize:"medium", width: 300}}>An offline workshop on Implementations of IOT and ..... </p>
                <a style={{textAlign: "left", textDecoration: "none", color: "#183883", fontWeight: 500, width:300}} href="./event1.html">Read More</a>
            </div>
            <div class="events-div">
                <img src={Event8} alt="event-img"/>
                <h1 style={{fontSize: 20, fontWeight: 600, margin: 0}}>IoT Project Expo</h1>
                <p style={{ textAlign: "justify", height: "fit-content", overflow: "hidden", fontSize:"medium", width: 300}}>A project expo which unveiled the IOT projects created by.......</p>
                <a style={{textAlign: "left", textDecoration: "none", color: "#183883", fontWeight: 500, width:300}} href="./event2.html">Read More</a>
            </div>
            <div class="events-div">
                <img src={Event9} alt="event-img"/>
                <h1 style={{fontSize: 20, fontWeight: 600, margin: 0}}>Code-a-thon</h1>
                <p style={{ textAlign: "justify", height: "fit-content", overflow: "hidden", fontSize:"medium", width: 300}}>A coding competition conducted in online platform.... </p>
                <a style={{textAlign: "left", textDecoration: "none", color: "#183883", fontWeight: 500, width:300}} href="./event3.html">Read More</a>
            </div>
        </div>
    </div>
